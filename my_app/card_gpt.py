...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        # 처음 뜨는 화면 내용을 설정
        {"role": "assistant", "content": "🤖 안녕하세요, 저는 AI 카드 추천 Assistant 입니다."}
    ]
...
# 프롬프트 탬플릿 작성: 대화 기록을 기반으로 ai의 응답을 유도
system_prompt = """
...
user_prompt = """
아래의 사용자의 question을 읽고 context를 참고하여 가장 적합한 카드(사용자가 혜택을 최대로 받을 수 있는 카드)를 추천해주세요.
...
# messages 리스트에 담긴 메시지가 ai 아닐 경우 
